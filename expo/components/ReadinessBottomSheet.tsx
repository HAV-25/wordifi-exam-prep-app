...
type ReadinessBottomSheetProps = {
  visible: boolean;
  onClose: () => void;
  level: string;
  overallScore: number;
...
export const ReadinessBottomSheet = React.memo(function ReadinessBottomSheet({
  visible,
  onClose,
  level,
  overallScore,
  ...
  return (
    <View style={styles.overlay} testID="readiness-bottom-sheet">
